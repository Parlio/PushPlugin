...
PushNotification.prototype.handlePendingNotifications = function(successCallback, errorCallback) {
    cordova.exec(successCallback, errorCallback, "PushPlugin", "handlePendingNotifications", []);
};
